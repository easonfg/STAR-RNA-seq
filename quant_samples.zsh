...
run_STAR(){
  ...
  echo $A
    ...
    --outFileNamePrefix quants/${A}_quant/${A}_

    qualimap_v2.2.1/qualimap rnaseq \
    -outdir quants/${A}_quant/qualimap \
    -bam quants/${A}_quant/${A}_Aligned.sortedByCoord.out.bam \
    -gtf ../genome/gencode.vM25.primary_assembly.annotation.gtf \
    --java-mem-size=64G

    htseq-count \
    -c quants/${A}_quant/output.count \
    quants/${A}_quant/${A}_Aligned.sortedByCoord.out.bam ../genome/gencode.vM25.primary_assembly.annotation.gtf
